...
# data=/home/dpinto/scratch/data/ASR_corpus
data=/home/dpinto/scratch/datasets
...
#
#    HASTA AQUI. Lo último ejecutado fue train_sat.sh
#
...
# train a NN model on the 960 hour set based on tri6b
