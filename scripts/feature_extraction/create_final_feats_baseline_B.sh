...
system_dir=~/scratch/ASR_system/baseline_B
...
global_cmvn_stats_file=${feat_dir}/cmvn/global_cmvn.stats
...
for file in $symbol_table_file $lda_transform_file $fmllr_first_pass_mdl_file $fmllr_second_pass_mdl_file $fmllr_decode_graph_file $diag_ubm_file $ivector_extractor_file; do
	if [ ! -f ${file} ]; then
